...
namespace mntsiwake
{
    class utility
    {
        ...
        public class DBConnect
        {
            ...
            /// ローカルデータベースへの接続
            /// </summary>
            /// <param name="sDBPath">パス</param>
            /// <param name="sDBName">データベース名</param>
        ...
        /// 任意のディレクトリのファイルを削除する
        /// </summary>
        /// <param name="sPath">指定するディレクトリ</param>
        /// <param name="sFileType">ファイル名及び形式</param>
        ...
        public static string GetConnect(String sDsnPath)
        {
            ...
            //stResult = "Provider=SQLOLEDB;" + @"Data Source=JIMUHONBU-PC\OBCINSTANCE3X;Initial Catalog=obc3sresource;Integrated Security=True;UID=obc;";
